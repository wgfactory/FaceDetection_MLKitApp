...
import com.wgf.faceapp.Helper.GraphicOverlay;
...
public class FaceGraphicOverlay extends GraphicOverlay.Graphic {
    ...
    public FaceGraphicOverlay(GraphicOverlay overlay, FirebaseVisionFace face) {
        super(overlay);
        ...
        final int boxColor = Color.RED;
        final int faceColor = Color.WHITE;

        facePositionPaint = new Paint();
        facePositionPaint.setColor(faceColor);
